		...
		<div class="col-md-12" style="width: 100%;">
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                <form class="form-horizontal" action="/admin/filemaintenance/moneytransfer/edit/{{ $moneytransfer->id }}" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="form-group row">
                    <label class="col-sm-3 form-control-label" name="name">Service Name</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="name" value="{{ $moneytransfer->name }}">
                      @if ($errors->has('name'))
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <textarea class="form-control" rows="8" id="article-ckeditor" name="instruction">{{ $moneytransfer->instruction }}</textarea>
