          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-header d-flex align-items-center">
                <h4>Showcase Registration Form</h4>
              </div>
              <div class="card-body">
                <form class="form-horizontal" action="/admin/filemaintenance/showcase/create" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 form-control-label">Showcase Banner</label>
                    <div class="col-sm-9">
